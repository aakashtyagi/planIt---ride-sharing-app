...
class HiddenInput(Input):
    template_name = 'forms/hidden.html'
    input_type = 'hidden'
...
class IPAddressInput(TextInput):
    template_name = 'forms/ipaddress.html'
...
class DateTimeInput(Input):
    template_name = 'forms/datetime.html'
    input_type = 'datetime'
    supports_microseconds = False
...
class URLInput(TextInput):
    template_name = 'forms/url.html'
    input_type = 'url'


class ColorInput(Input):
    template_name = 'forms/color.html'
    input_type = 'color'


class NumberInput(TextInput):
    template_name = 'forms/number.html'
    input_type = 'number'
    min = None
    max = None
    step = None
...
class PhoneNumberInput(Input):
    template_name = 'forms/phonenumber.html'
    input_type = 'tel'
...
class SelectDateWidget(forms.Widget):
    ...
    day_field = '%s_day'
    year_field = '%s_year'
    template_name = 'forms/select_date.html'
